...
@Slf4j //private static final Logger Log = LogManager.getLogger(CustomerController.class);
@Controller
...
//		session.invalidate();
	...
	public String modifyPw2(HttpSession session, Model model) {
